...
| **v5.0** | **Methodik-Workflow aktiviert: CLAUDE.md (Workflow-Regeln, Invarianten, Commit-Konventionen) · BACKLOG.md (BL-001–BL-003, strukturiertes Item-Format) · docs/PROJECT.md (Architektur, ADR-Entscheidungen, vollständiger Changelog) · .github/ISSUE_TEMPLATE · .gitignore korrigiert (war gitignore ohne Punkt — sensible Dateien wurden nie ignoriert)** |
