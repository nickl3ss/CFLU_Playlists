...
| #24 | fix(app): Selektions- und Pool-Genre-Logik entkoppelt — state.poolGenre als SSOT; Direktsuche durchsucht kompletten Pool; genre-sel nur noch Filter-Kontrolle; externer Link-Track erhält eigenen Genre-Dropdown; Pool-Badge in Selected-Display; #3 als Duplicate geschlossen | 2026-06-06 | – |
